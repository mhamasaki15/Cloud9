...
class FeatureContext implements Context
{
     ...
     */
    public function thereIsATextboxInTheArtistWebPage()
    {
    ...
    /**
     * @Then I should have the ability to choose the artist
     */
    public function iShouldHaveTheAbilityToChooseTheArtist()
    {
        throw new PendingException();
    }
